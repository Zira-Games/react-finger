(function (exports, React, reactDom) {
    ...
    ***************************************************************************** */
    ...
    var FingerBoxWrapper = FingerProxyContainer("div");
    var FingeredDiv = (Finger('div'));
    var boxStyle = {
        margin: 'auto',
        padding: 16,
        borderRadius: 8,
    ...
    var onShortcut = function (event) {
        ...
        event.when(["meta", "c"], function () {
            console.log('FingerProxy onShortcut', event);
        });
        event.when(["meta", "v"], function () {
            console.log('FingerProxy onShortcut', event);
        });
    };
    function App() {
        return (React__default["default"].createElement(FingerBoxWrapper, { className: 'box', style: boxStyle, tabIndex: 0 },
            React__default["default"].createElement(FingerProxy, { onShortcut: onShortcut }),
            React__default["default"].createElement(FingeredDiv, { onTapHold: function (event) { return console.log('onTapHold', event); }, onDoubleTap: function (event) { return console.log('onDoubleTap', event); }, onFingerDown: function (event) { return console.log('onFingerDown', event); }, onPinch: function (event) { return console.log('onPinch', event); }, onPointerDown: function (event) { return console.log('onPointerDown', event); } }, "Tap me"),
            React__default["default"].createElement("div", null, "123")));
    }
    var root = client_1(document.getElementById("root"));
    root.render(React__default["default"].createElement(App, null));

    exports.App = App;
    exports.FingerBoxWrapper = FingerBoxWrapper;
    exports.FingeredDiv = FingeredDiv;
    exports.boxStyle = boxStyle;
    exports.onShortcut = onShortcut;
